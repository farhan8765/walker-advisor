...
const relatedArticles = [
  ['Social Activities for Older Adults: The Best Ways to Stay Connected, Active, and Happy', 'Loneliness in seniors is not just sad, it is as dangerous to health as smoking 15 cigarettes a day. Here are the best ways older', 'https://darkcyan-lion-250828.hostingersite.com/wp-content/uploads/2026/04/unnamed-768x512.png'],
  ['Can Heart Issues Increase Fall Risk in Seniors?', 'You might think falls are just about balance, but what if your heart is the real culprit? Discover the hidden connection between heart issues and', 'https://darkcyan-lion-250828.hostingersite.com/wp-content/uploads/2026/04/image-2-1-768x429.png'],
  ['3 Foods for Seniors to Avoid', 'Your body after 60 is a different machine entirely. Metabolism slows. The immune system becomes more reactive. Kidneys filter less efficiently, and the gut microbiome', 'https://darkcyan-lion-250828.hostingersite.com/wp-content/uploads/2026/03/image-11-768x429.png'],
];
      ...
      <main className="mx-auto w-full max-w-[1080px] bg-white px-4 pb-12 sm:px-6 lg:px-8">
        <article className="blog-detail-article w-full">
          <header className="pt-9 text-center">
            ...
            <img className="mx-auto mt-5 h-auto w-full max-w-[700px] rounded-[8px] object-contain" src="https://darkcyan-lion-250828.hostingersite.com/wp-content/uploads/2025/11/twa-30-1-e1762924166336.png" alt="Woman giving a Christmas present to a senior woman" />
          </header>
          <div className="mt-6 flex items-center gap-3"><img className="h-8 w-8 rounded-full object-cover" src="https://darkcyan-lion-250828.hostingersite.com/wp-content/uploads/2025/08/robin-2.jpg" alt="Robin Dolan" /><p className="font-manrope text-[12px] font-black text-black">Robin Dolan</p></div>
          ...
          <section className="mt-9 rounded-[10px] bg-[#f3f3f3] p-6">
            ...
            <p className="mt-4 font-manrope text-[12px] font-medium text-[#1f2930]">
              <a className="font-black text-[#0b61a4]" href="https://darkcyan-lion-250828.hostingersite.com/best-upright-walker-for-balance-problems-top-rated-walkers-for-stability-support/">
                ...
                <article className={`rounded-[8px] border border-[#d8dde2] p-4 ${isReply ? 'ml-6 bg-[#fafafa]' : 'bg-white'}`} key={`${author}-${body}`}>
                  <div className="flex items-center gap-3">
                    <img
                      ...
                      src={isReply
                        ? 'https://darkcyan-lion-250828.hostingersite.com/wp-content/uploads/2025/09/robin-dolan_avatar-73x73.jpg'
