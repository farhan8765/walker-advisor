      ...
      <main className="mx-auto w-full max-w-[1080px] bg-white px-4 pb-12 sm:px-6 lg:px-8">
        <article className="blog-detail-article w-full">
          <header className="pt-9 text-center">
            ...
            <p className="mx-auto mt-3 max-w-[620px] font-manrope text-[12px] font-medium leading-6 text-[#1f2930]">From slippery sidewalks to scorching heat, here's how seniors can navigate any weather with confidence.</p>
            <img className="mt-5 h-auto w-full rounded-[8px] object-cover" src={`${process.env.PUBLIC_URL}/images/twa-blog12.jpg`} alt="Rain, Snow, or Shine, How to Stay Safe with Your Walker" />
          </header>
