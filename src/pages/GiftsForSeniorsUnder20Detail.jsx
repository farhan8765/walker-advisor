        ...
        <article className="blog-detail-article w-full">
          ...
          <div className="blog-table-wrap mt-4 overflow-x-auto">
            <table className="blog-data-table w-full min-w-[520px] border-collapse font-manrope text-[12px]">
              <thead><tr><th>Product Name</th><th>Price Range</th><th>Link</th></tr></thead>
              <tbody>{gifts.map(([title, price, href]) => <tr><td>{title.replace(/^\d+\.\s*/, '')}</td><td>{price}</td><td><a className="font-black text-[#0b61a4]" href={href} target="_blank" rel="noopener noreferrer">Get It Now</a></td></tr>)}</tbody>
            </table>
          </div>
