    ...
    <>
      ...
      <main className="bg-white px-4 pb-12">
        <article className="mx-auto max-w-[620px]">
          ...
          <section className="mt-9 rounded-[10px] bg-[#f3f3f3] p-6" id="section-6"><div className="flex items-center gap-3"><span className="text-[24px] text-[#ffc400]">◇</span><h2 className="text-[18px] font-black text-black">Final Thoughts</h2></div><Paragraph>A walker can improve mobility on flat surfaces, but stairs are different. For seniors, the safest choice is usually to avoid stairs, use handrails and assistance, and invest in safer long-term home solutions.</Paragraph></section>

          <section className="mt-8 rounded-[10px] bg-[#f3f3f3] p-6" id="section-7"><div className="flex items-center gap-3"><span className="text-[22px] text-[#ffc400]">↪</span><h2 className="text-[18px] font-black text-black">References</h2></div><ol className="mt-4 list-decimal space-y-2 pl-5 font-manrope text-[11px] font-semibold leading-5 text-[#1f2930]"><li>Centers for Disease Control and Prevention: older adult fall prevention.</li><li>American Physical Therapy Association: mobility and stair safety guidance.</li><li>National Institute on Aging: home safety and fall prevention.</li></ol></section>
